            ...
            <div class="row" >
                ...
                <div class="col">
                    ...
                    <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="sortRadio" <?php
                ...
                <div class="col-4">
                    <div class="input-group rounded">
                        <input type="search" name="searchValue" class="form-control rounded" placeholder="Search" aria-label="Search" aria-describedby="search-addon" style="min-width:250px"/>
